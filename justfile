...
build-extractor:
  # this repository target will change once the PR is merged:
  # https://github.com/minecraft-linux/mcpelauncher-extract/pull/4
  git clone https://github.com/justdan96/mcpelauncher-extract.git -b ng
...
deb-extractor:
  ...
  --pkgsource https://github.com/minecraft-linux/mcpelauncher-extract --pkggroup mcpelauncher --nodoc --pkgversion 0.4.0-$(cd .. && git rev-parse --short HEAD) \
